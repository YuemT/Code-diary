...
3. [什么是变量？](#b3)
4. [内存，数据，变量三者的关系](#b4)
5. [问题：var a = xxx, a内存中到底保存的是什么?](#b5)
6. [关于引用变量赋值问题](#b6)
7. [关于数据传递的问题](#b7)
8. [内存管理](#b8)
#### [三.对象](#c)
...
4. [练习题](#f4)
5. [依次输出什么?](#f5)
6. [整个过程中产生了几个执行上下文?](#f6)
7. [面试题](#f7)
    * [函数提升优先于变量提升(函数后提升)](#f8)
#### [三.作用域与作用域链](#g)
1. [作用域](#g1)
2. [作用域与执行上下文](#g2)
3. [作用域链](#g3)
...
## <div id='one'></div>基础总结深入<div id='one'></div>
#### <div id='a'></div>一.数据类型
1. <div id='a1'>分类</div>
